...
let allowedOrigins = ['http://localhost:1234', 'http://localhost:50457', 'http://localhost:51693', 'https://myflix-firstmovieapp.herokuapp.com/', 'https://myflix-firstmovieapp.cyclic.app'];
app.use(cors({
